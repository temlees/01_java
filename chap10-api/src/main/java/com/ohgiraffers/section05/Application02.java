...
public class Application02 {
    public static void main(String[] args) {
        ...
        /*
        * Calendar 클래스는 abstract 클래스로 작성되어있다
        * 따라서 calendar 클래스를 이용해서 인스턴스 생성 불가능
        *
        * Calendar 클래스를 이용한 인스턴스 생성 방법에는 두가지가 있다
        * 1. getInstance() static메소드를 이용하는 방법
        * 2. 후손 클래스인 GrrgorianCalendar() 클래스를 이용해 인스턴스 생성방법
        *
        *
        * */

        //getInstance() static 이용
        // 추상클래스이기 때문에 인스턴스 생성을 getInstace로 한다.
        ...
        //년 월 일 시 분 초 를 이용해 인스턴스 생성.
        //2024 08 16 14시 37분 00초
        ...
        Calendar today = new GregorianCalendar(year, month, dayOfMonth, hour, min, second);
